...
export function FilesBrowserClient({ files, directories, onSelect, onSelectionChange, onMoveFiles, onFileCreate, onDirectoryCreate, onDirectoryChange, className, emptyStateMessage = "Henüz yüklenmiş dosya yok.", initialdirectory_id = null, activedirectory_id: controlleddirectory_id, showFiles = true, showDirectories = true, showUpload = true, showDirectoryCreate = true, multiSelect = false, enableDragDrop = false, selectedFileIds, }) {
    ...
    return (_jsxs("div", { className: cn("space-y-6", className), children: [_jsxs("section", { className: "rounded-2xl border border-gray-200 bg-white p-5 shadow-sm dark:border-white/10 dark:bg-gray-900", children: [_jsxs("header", { className: "mb-4 flex items-center justify-between", children: [_jsx("div", { children: _jsx("p", { className: "text-sm font-semibold text-gray-900 dark:text-white", children: showFiles ? "Dosyalar" : "Klasörler" }) }), _jsxs("div", { className: "flex flex-wrap items-center gap-2", children: [showDirectoryCreate ? (_jsx(Button, { type: "button", variant: "outline", onClick: () => setIsCreateModalOpen(true), children: "Klas\u00F6r Olu\u015Ftur" })) : null, showUpload ? (_jsx(Button, { type: "button", onClick: () => setIsUploadModalOpen(true), children: "Dosya Y\u00FCkle" })) : null] })] }), _jsxs("div", { className: "grid gap-4 md:grid-cols-2", children: [activedirectory_id && (_jsxs("button", { className: cn("flex items-center gap-3 rounded-xl border border-dashed border-gray-300 px-4 py-3 text-left text-sm text-gray-600 transition hover:border-indigo-400 dark:border-white/10 dark:text-gray-300 dark:hover:border-indigo-400", dragOverTarget === "__up__"
                                    ? "border-indigo-500 bg-indigo-50 dark:border-indigo-400 dark:bg-indigo-500/10"
                                    : null), type: "button", onClick: () => handleEnterDirectory(parentdirectory_id), onDragOver: handleDragOverTarget("__up__"), onDragLeave: handleDragLeaveTarget, onDrop: handleDropTarget(parentdirectory_id), children: [_jsx(ArrowUturnLeftIcon, { className: "h-5 w-5" }), "\u00DCst Klas\u00F6re \u00C7\u0131k"] })), visibleDirectories.length === 0 && visibleFiles.length === 0 ? (_jsx("p", { className: "rounded-md border border-dashed border-gray-300 p-6 text-center text-sm text-gray-500 md:col-span-2 dark:border-white/10 dark:text-gray-400", children: emptyStateMessage })) : (_jsxs(_Fragment, { children: [showDirectories
