...
export declare const uploadFileAction: (data: UploadFileActionInput) => Promise<import("..").ActionState<UploadFileState>>;
export declare const updateFileAction: (data: UpdateFileActionInput) => Promise<import("..").ActionState<UpdateFileActionOutput>>;
export declare const softDeleteFileAction: (data: SoftDeleteFileActionInput) => Promise<import("..").ActionState<SoftDeleteFileActionOutput>>;
export declare const createDirectoryAction: (data: CreateDirectoryActionInput) => Promise<import("..").ActionState<CreateDirectoryActionOutput>>;
export declare const deleteDirectoryAction: (data: DeleteDirectoryActionInput) => Promise<import("..").ActionState<DeleteDirectoryActionOutput>>;
export declare const updateDirectoryAction: (data: UpdateDirectoryActionInput) => Promise<import("..").ActionState<UpdateDirectoryActionOutput>>;
export declare const getFilesAction: (data: {
    includeDeleted?: boolean;
}) => Promise<import("..").ActionState<{
