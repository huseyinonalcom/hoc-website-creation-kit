...
export function ClipboardFormSection({ componentKey, title, children, getValue, sanitize, onPaste, description, copyLabel = "Kopyala", pasteLabel = "Yapıştır", statusMessages, }) {
    ...
    return (_jsxs("div", { className: "space-y-4", children: [_jsxs("div", { className: "flex flex-wrap items-center justify-between gap-2", children: [_jsxs("div", { children: [_jsx("p", { className: "text-sm font-semibold text-gray-800 dark:text-gray-200", children: title }), status !== "idle" ? (_jsx("p", { className: "text-xs text-gray-500", children: mergedStatusMessages[status] })) : description ? (_jsx("p", { className: "text-xs text-gray-500", children: description })) : null] }), _jsxs("div", { className: "flex gap-2", children: [_jsx(Button, { disabled: !clipboardSupported || isBusy, type: "button", variant: "outline", onClick: handleCopy, children: copyLabel }), _jsx(Button, { disabled: !clipboardSupported || isBusy, type: "button", variant: "outline", onClick: handlePaste, children: pasteLabel })] })] }), children ?? null] }));
}
