...
export const createFirstAdminUser = async (data) => {
    try {
        ...
        const { password, ...firstAdminUserDataWithoutPassword } = rawFirstAdminUserData;
        const dataToInsert = {
...
//# sourceMappingURL=create_first_user.js.map