...
export function Clipboard({ componentName }) {
    ...
    return (_jsx("div", { className: "space-y-4", children: _jsxs("div", { className: "flex flex-wrap items-center justify-between gap-2", children: [_jsx("div", { children: _jsx("p", { className: "text-sm font-semibold text-gray-800 dark:text-gray-200", children: componentName }) }), _jsxs("div", { className: "flex gap-2", children: [_jsx(Button, { disabled: !clipboardSupported || isBusy, type: "button", variant: "outline", onClick: handleCopy, children: _jsx(DocumentDuplicateIcon, { className: "h-4 w-4" }) }), _jsx(Button, { disabled: !clipboardSupported || isBusy, type: "button", variant: "outline", onClick: handlePaste, children: _jsx(ClipboardIcon, { className: "h-4 w-4" }) }), status === "success" ? (_jsx(CheckCircleIcon, { className: "h-4 w-4 text-green-500", "aria-hidden": "true" })) : status === "error" ? (_jsx(XCircleIcon, { className: "h-4 w-4 text-red-500", "aria-hidden": "true" })) : null] })] }) }));
}
