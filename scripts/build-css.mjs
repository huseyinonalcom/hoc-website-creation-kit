...
const quillSourcePath = path.join(
  repoRoot,
  "node_modules",
  "quill",
  "dist",
...
const richTextTablePath = path.resolve(
  __dirname,
  "..",
  "src",
  "richtext-table.css",
);
const combinedTargetPath = path.resolve(
  __dirname,
  "..",
  "src",
  "hoc-website-creation-kit.css",
);
...
const sync = async () => {
  ...
  await writeFile(
    combinedTargetPath,
    buildCombinedCss({ puckCss, quillCss, tableCss }),
    "utf8",
  );
