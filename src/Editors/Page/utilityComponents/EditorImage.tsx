...
import type { CreateDirectoryInput, CreateDirectoryResponse, SerializableFileRecord, UploadFileInput } from "../../../FileManagement/types";
import type { UploadFileState } from "../../../FileManagement/state";

import { useFilesData } from "../../../FileManagement/Providers/FilesDataProvider";
import { FilesPickerModal } from "../../../FileManagement/FilesPickerModal";
...
export function EditorImage({ value, onChange, onUploadFile, onCreateDirectory }: EditorImageProps) {
    ...
    <div className="space-y-4 rounded-2xl border border-gray-200 p-4 shadow-sm">
      ...
      {value && (
        <div className="relative aspect-video w-full overflow-hidden rounded-xl border border-gray-100 bg-gray-50">
          <Image fill alt={deriveFileName(value)} className="object-cover" sizes="(max-width: 768px) 100vw, 50vw" src={value} />
        </div>
      )}
