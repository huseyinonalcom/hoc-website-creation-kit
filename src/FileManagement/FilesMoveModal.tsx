...
export function FilesMoveModal({ open, directories, onClose, onConfirm, initialDirectoryId = null, title = "Klasor Sec" }: FilesMoveModalProps) {
  const [activeDirectoryId, setActiveDirectoryId] = useState<string | null>(initialDirectoryId);
