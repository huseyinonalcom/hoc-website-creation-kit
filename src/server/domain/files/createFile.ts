...
const sanitizeName = (name: string) => name.replace(/[^a-zA-Z0-9._-]/g, "-").replace(/-+/g, "-");
...
export const createFile = async ({
  ...
  if (!bucketName || !publicBase) throw new Error("R2_BUCKET and R2_PUBLIC_URL must be configured");
